...
//				menu += '</tr><tr> ';
	...
	exec: function (key)
	{
		...
		switch(key) {
		case "EVENT1" :
			(this.popup == '1' ? popup :popupLayer)('/shop/admin/member/crm_view?mid=' + this.m_id,780,600);
		break;
		case "EVENT2" :
		...
		break;
		case "EVENT4" :
			(this.popup == '1' ? popup :popupLayer)('/shop/admin/member/orderlist?mno=' + this.m_no,500,600);
		break;
		case "EVENT5" :
			(this.popup == '1' ? popup :popupLayer)('/shop/admin/member/popup.emoney?mno=' + this.m_no,600,500);
		break;
		}
	}
}
...
function panel(idnm, section)
{
	...
	var ajax = new Ajax.Request( "/shop/admin/common/indb",
	{
		method: "post",
...
var onErrorImg = function(obj, errImg, skin){
	var path = '/shop/data/skin/en/img/common/';
	if ( null !== skin && '' !== skin) {
		path = '/shop/data/skin/'+skin+'/img/common/';
	}
