...
//					document.getElementById('day_'+date_ID).innerHTML = "<font color='#3F85C2'>☎</font>";
	...
	sc+= "<div style=\"float:left;font-size:8pt;letter-spacing:0px;font-family:tahoma;color:#3ca701\">" + now_scY + "</div>";
	...
	calender_area+="<tr>";
		...
		for (i=1;i<=last_date.getDate();i++)
		{
			...
			if(i == now.getDate() && now.getFullYear()==static_now.getFullYear() && now.getMonth()==static_now.getMonth()) {
				...
				calender_area+="<td width='32' height='28' "+ Tdopt + mouse_st + " style='color:#86C800;'><B>"+Mover_div+i+"</B><span style='color:#ffffff' id='day_"+ii+"'></span>"+today_msg+"</td>";
			}else{ //평일
				calender_area+="<td width='32' height='28' "+ Tdopt + mouse_st + "><B>"+Mover_div+i+"</B><span style='color:#ffffff' id='day_"+ii+"'></span>"+today_msg+"</td>";
			}
	...
	function alarm_pop(thisDay){
		window.open("malldiary_popup.html?thisDay="+thisDay,"_alarm","width=300, height=237,scrollbars=yes,top=200,left=200");
	}
