...
imgHost = {
	...
	ftpVerify : function (fObj)
	{
		...
		var parameters = decodeURIComponent(Form.serialize(fObj).replace(/%26/,"&&")).replace(/&&/,"%26");
		var ajax = new Ajax.Request( urlStr,
		{
			method: "post",
			parameters: parameters,
...
<tr>\
	<td height=28 align=right style="font-family: verdana; font-size: 8pt; letter-spacing:-1;"><font color="#777777"><b>FTP 도메인</td>\
	<td bgColor="#eeeeee"><b>ftp://<span id="domain"></span>.godohosting.com</b></td>\
</tr>\
<tr>\
