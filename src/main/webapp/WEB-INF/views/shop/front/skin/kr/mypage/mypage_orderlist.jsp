			...
			<div class="">
				<div class="tab-pane fade in active">
					...
					<div class="my_tab_ty01">
						<ul>
							<li><a href="#" class="on">주문내역 (${orderStepInfo.cnt6})</a></li>
							<li><a href="/shop/mypage/mypage_cancellist">취소/환불내역 (${orderStepInfo.cnt7})</a></li>
						</ul>
						<div style="clear:both;"></div>
					</div>

					<form name="frmList" id="frmList" method="post" action="${ctx}/shop/mypage/mypage_orderlist">
