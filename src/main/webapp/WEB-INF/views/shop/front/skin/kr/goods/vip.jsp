...
<form name="frmList" id="frmList" method="get" action="${ctx}/shop/goods/vip">
	...
	<input type="hidden" name="pageSize" value="${frontGoodsVO.pageSize}">
 	...
 	<div class="global-wrapper clearfix" id="global-wrapper">
		<div class="top_tit_ty01">
			<div class="tit_dp01 tit_mob_n">VIP</div>
	
			<div class="bx_banner01">
				<img src="/resources/shop/data/skin/kr/images/banner_vip.jpg" alt="" style="width:100%;" class="img_pc" />
				<img src="/resources/shop/data/skin/kr/images/banner_vip_mob.jpg" alt="" style="width:100%;" class="img_mob" />
				<p class="bt_tx">VIP SHOP은 V1등급 이상부터 구매가 가능하며 구매에 따른 별도의 적립은 불가합니다.<span>i</span></p>
			</div>
		</div>
								...
								<div class="in_cate_list pr_bx_in">
									...
									<ul>
										<c:forEach var="ctList" items="${frontGoodsVO.frontGoodsGoodsCategoryList }" varStatus="status">
											<li class="dp2">
												<div class="s_tit_n03">
													<a href="${ctx}/shop/goods/vip?category=${ctList.category}">${ctList.catnmKR} (${stringUtil:getMoneyFormatInteger(ctList.goodsCnt)})</a>
												...
												<c:if test="${ctList.categoryList ne ''}">
													<ul class="bx_dp3">
														<c:forEach var="subCtList" items="${ctList.categoryList}" varStatus="substatus">
															<li class="dp3"><a href="${ctx}/shop/goods/vip?category=${subCtList.category}">${subCtList.catnmKR} (${stringUtil:getMoneyFormatInteger(subCtList.goodsCnt)})</a></li>
														</c:forEach>
													</ul>
												</c:if>
											</li>
