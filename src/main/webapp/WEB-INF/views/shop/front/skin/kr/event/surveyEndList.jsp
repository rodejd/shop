	...
	<div class="tabbable product-tabs">
		...
		<div class="tab-content nb">
			<div class="tab-pane fade in active">
				<div class="row">
					<div class="col-md-12"><i class="fa fa-play"></i> 총 <strong class="txt-dark-gray under-line">${surveyVO.rowCount }건</strong> 의 종료된 설문조사가 있습니다.</div>
				</div>
					...
					<div class="row event_list" data-gutter="15">
		                <div class="col-md-12 text-center">
		                    <div class="banner banner-o-hid">
		                        <a href="surveyDetail?sno=${rtList.surveySno}&mode=endSurvey">
									${rtList.surveyTitle}
