...
<form name="frmList" id="frmList" method="get" action="${ctx}/shop/goods/new">
	...
	<input type="hidden" name="schSpec" value="${frontGoodsVO.schSpec}">
	...
	<input type="hidden" name="pageSize" value="${frontGoodsVO.pageSize}">
 	...
 	<div class="global-wrapper clearfix" id="global-wrapper">
		...
		<div class="top_tit_ty01">
			<div class="tit_dp01">NEW ARRIVAL</div>
		</div>
		
		<div class="tab_new_n01">
			<ul>
				<li><a href="${ctx}/shop/goods/new"${frontGoodsVO.schSpec eq 'N' ? ' class="on"' : ''}>신규등록상품</a></li>
				<li><a href="${ctx}/shop/goods/new?schSpec=22SS"${frontGoodsVO.schSpec ne 'N' ? ' class="on"' : ''}>NEW SEASON</a></li>
			</ul>
		</div>
