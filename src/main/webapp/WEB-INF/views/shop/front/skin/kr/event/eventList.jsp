	...
	<div class="tabbable product-tabs">
		...
		<div class="tab-content nb">
			<div class="tab-pane fade in active">
				<div class="row">
					<div class="col-md-12"><i class="fa fa-play"></i> 총 <strong class="txt-dark-gray under-line">${frontEventVO.rowCount }건</strong> 의 진행중인 이벤트가 있습니다.</div>
				</div>
				
				<div class="gap"></div>
				
				<c:if test="${fn:length(frontEventVO.frontEventList) == 0}">
				<div class="row">
					<div class="row" data-gutter="15">
		                <div class="col-md-12 text-center">
		                    <div>
		                        <p>진행중인 이벤트가 존재하지 않습니다.</p>
		                    </div>
		                </div>
		            </div>
				</div>
				...
				<c:if test="${fn:length(frontEventVO.frontEventList) > 0}">
				<div class="row">
					<c:forEach var="rtList" items="${frontEventVO.frontEventList }"  varStatus="status">
					<c:if test="${rtList.wview eq 'y' }">
					
					<div class="row event_list" data-gutter="15">
		                <div class="col-md-12 text-center">
		                    <div class="banner banner-o-hid">
		                        <a href="eventDetail?sno=${rtList.sno}">
