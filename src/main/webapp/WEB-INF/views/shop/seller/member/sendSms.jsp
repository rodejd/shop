...
function goSend() {
	...
	ajaxCallJsonPost("/shop/seller/member/send.dojson", "frm2", function(result){
		alert(JSON.stringify(result));
		alert(result.total + '건 SMS가 발송되었습니다.');
		location.href=ctx + "/shop/seller/member/sendSms";
	});
}
...
<input type="hidden" name="returnUrl" value="/shop/admin/index.jsp">

<table class="tb">
<col class="cellC"><col class="cellL">
<tr>
	<td align="left"><input type="radio" name="type" id="type1" value="1" class="null" checked><font color="262626">개별 발송</font></td>
	<td>
...
<tr>
	...
	<td>
		<select id="klevel" name="klevel">
			...
			<c:forEach items="${ sellerSmsFM.gdMemberGrpList }" var="gdMemberGrpList" varStatus="st">
