			...
			<td>
				<div id="${printVO.classids[status.index]}">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tbody><tr>
							<td height="100%" valign="top" style="border-width: 3px 1px 0 0; background: url(/resources/shop/data/skin/season2/img/common/seal.JPG) no-repeat; background-position: 235px 15px;">
