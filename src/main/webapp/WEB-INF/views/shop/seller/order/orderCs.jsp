...
================================================================================ --%>
			...
			<div class="title title_top">
				주문취소리스트 [조회] <span> 주문취소접수/주문취소완료, 교환접수/재주문, 반품접수/반품완료, 환불접수/환불완료 주문건을 조회합니다. </span><!-- <a href="javascript:popup('http://guide.godo.co.kr/season2/board/view.php?id=order&no=3',870,800)"><img src="/resources/shop/admin/img/btn_q.gif" border="0" align="absmiddle" hspace="2"></a> -->
			</div>
		...
		<c:when test="${listSize > 0 }">
			<c:forEach items="${cancelList}" var="cancelData" varStatus="status">
				<tr bgcolor="${cancelData.bgColor}" height="25">
					...
					<!-- 주문번호 -->
					<td align="center">
						<a href="javascript:popup('${ctx }/shop/seller/order/popupOrder?ordno=${cancelData.ordno}',800,600)">
						...
						<a href="javascript:popup('../goods/register?viewFlg=view&mode=modify&goodsno=${cancelData.goodsno}',825,600)">
							<font class="small1" color="444444">
								<div style="float:left;text-overflow:ellipsis;overflow:hidden;width:150px" nowrap>
									${cancelData.goodsnm} [판매사 : ${cancelData.sellerNm }]
								</div>
							</font>
						</a>
