...
<form method="post" action="indb">
	...
	<table width="100%" cellpadding="2" cellspacing="0">
		...
		<c:choose>
			<c:when test="${not empty regoodsVO.regoodsList }">
				...
				<tr>
					...
					<td><a href="javascript:popup('${ctx }/shop/seller/order/popupOrder?ordno=${list.ordno}',800,600)"><font class="ver71" color="0074BA"><b>${list.ordno}</b></font></a></td>
					<td>
					...
					<td colspan="10" style="padding:5px 10px" align="left">
						<table width="100%" border="1" bordercolor="#dedede" style="border-collapse:collapse">
							...
							<tr>
									...
									<table>
										<tr>
											...
											<td style="padding-left:3px"><font class="small" color="444444">
												...
												<c:if test="${fn:trim(infoList.optname) != '' and infoList.optname != null}">
													[상품옵션 : ${infoList.optname }]
												</c:if>
								...
								<td><font class="ver7" color="444444"><c:set var="addopt" value="${infoList.addopt }" />
			...
			<c:otherwise>
				<tr bgcolor="#FFFFFF" height="25">
					<td align="center" colspan="7"> 주문취소 내역이 존재하지 않습니다. </td>
				</tr>
			</c:otherwise>
		</c:choose>
