				...
				<table width=100%>
					<tr>
						<td>
							<font class=small1>
								<c:choose>
									<c:when test="${popupVO.rtData.istep < 5}">
								...
								<c:if test="${popupVO.cnt > 0 }">
									...
									<font class=small1 color=444444>
										...
										(<c:forEach items="${popupVO.newordno}" var="ordno">
											<a href="javascript:popup('popupOrder?ordno=${ordno}',800,600)">
								...
								<c:if test="${popupVO.rtData.oldordnoN2S != 0}">
									...
									<font class=small1 color=444444>이 주문은 
										...
										(<a href="javascript:popup('popupOrder?ordno=${popupVO.rtData.oldordno}',800,600)">
											<font color=0074BA class=ver81>
