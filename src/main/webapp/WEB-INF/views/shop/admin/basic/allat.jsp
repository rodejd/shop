...
function chkSettleKind(){
	...
	var robj =  new Array('pg_id','pg_formkey','pg_crosskey','pg_quota');
...
function chkFormThis(f){
	...
	var p_formkey =  document.getElementsByName('pg_formkey')[0];
	var p_crosskey = document.getElementsByName('pg_crosskey')[0];
	...
	if(!p_formkey.value && ret){
		p_formkey.focus();
		alert('All@Pay Form Key는 필수항목입니다.');
		return false;
	}
...
window.onload = function(){
	...
	올앳PG 설정<span>신용카드 결제 및 기타결제방식은 반드시 전자결제서비스 업체와 계약을 맺으시기 바랍니다</span> 
	<!--<a href="javascript:popup('http://guide.godo.co.kr/season2/board/view.php?id=basic&no=6',870,800)"><img src="../img/btn_q.gif" border="0" align="absmiddle"></a>-->
	</div>

	<form method="post" action="indb" onsubmit="return chkFormThis(this)">
		<input type="hidden" name="mode" value="allat">
		<input type="hidden" name="settlePg" value="allat">
		...
		<div id="MSG01">
			<table cellpadding="1" cellspacing="0" border="0" class="small_ex">
				<tbody>
					...
					<tr><td style="padding-left:10">②<u>계약서류를 우편으로 올앳에 보내</u>주세요 <a href="intro" target="_blank" style="color:#ffffff;font-weight:bold">[계약 상세안내]</a></td></tr>
				</tbody>
			</table>
		</div>
		...
		<table border="1" bordercolor="#e1e1e1" style="border-collapse:collapse" width="100%">
			...
			<tbody>
				<tr>
					<td>PG사</td>
					<td class="noline"><b>올앳 (All@Pay™ Plus 2.0) ${pgVO.spot} </b></td>
				</tr>
				<tr>
					<td>결제수단 설정</td>
					<td class="noline">
				...
				<tr class="ver8">
					<td><b>All@Pay ID</b></td>
					<td><input type="text" name="pg_id" class="lline" value="${pgVO.pg_id}" > <font class="extext">올앳에서 메일로 받은 ID를 넣으세요</font></td>
				</tr>
				<tr class="ver8">
					<td><b>All@Pay Form Key</b></td>
					<td><input type="text" name="pg_formkey" class="lline" value="${pgVO.pg_formkey}" > <font class="extext">Form Key를 넣으세요</font></td>
				</tr>
				<tr class="ver8">
					<td><b>All@Pay CrossKey</b></td>
					<td><input type="text" name="pg_crosskey" class="lline" value="${pgVO.pg_crosskey}" > <font class="extext">CrossKey를 넣으세요</font></td>
				</tr>
				<input type="hidden" name="pg_ssl" value="NOSSL">
				<tr>
					<td>일반할부기간</td>
					<td>
				...
				<tr>
					<td>인증 여부</td>
					<td class="noline">
						<input type="radio" name="pg_cert" value="Y" ${pgVO.pg_cert  eq "Y"?"checked":""}> 인증
						<input type="radio" name="pg_cert" value="N" ${pgVO.pg_cert  eq "N"?"checked":""}> 인증 사용않음
					</td>
				</tr>
				<tr>
					<td>보너스 포인트</td>
					<td class="noline">
						<input type="radio" name="pg_bonus" value="Y" ${pgVO.pg_bonus  eq "Y"?"checked":""}> 사용
						<input type="radio" name="pg_bonus" value="N" ${pgVO.pg_bonus  eq "N"?"checked":""}> 사용안함
					</td>
				</tr>
			</tbody>
		</table>
		...
		<table border="1" bordercolor="#e1e1e1" style="border-collapse:collapse" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<!--<a href="javascript:popup('http://guide.godo.co.kr/season2/board/view.php?id=basic&no=9',870,800)"><font class="extext_l">[표시이미지 보기]</font></a></div>-->
					</td>
					<td class="noline">
				...
				<tr>
					<td>
								...
								<tr>
									<td>
										...
										<table width="100%" height="100" class="tb" style="border: 1px solid #cccccc;" bgcolor="white">
											<tbody>
												<tr>
													<td width="30%" style="border: 1px solid #cccccc; padding-left: 20">
														①[메인페이지 하단] 표기방법
													</td>
													<!--<td align="center" rowspan="2" style="border: 1px solid #cccccc; padding: 0 10 0 10">
														<a href="javascript:popup('http://guide.godo.co.kr/season2/board/view.php?id=basic&no=10',870,800)"><img src="../img/icon_sample.gif" align="absmiddle"></a>
													</td>-->
													<td width="70%" style="border: 1px solid #cccccc; padding-left: 40">
														<font class="extext">
															<a href="../design/codi.jsp?design_file=outline/footer/standard.htm" target="_blank"><font class="extext"><b>[디자인관리 &gt; 전체레이아웃 디자인 &gt; 하단디자인 &gt; html소스 직접수정]</b></font>
															</a> 을 눌러<br>치환코드 <font class="ver8" color="000000"><b>{=displayEggBanner()}</b></font>
															를 삽입하세요. 
															<a href="../design/codi.jsp?design_file=outline/footer/standard.htm" target="_blank"><font class="extext_l">[바로가기]</font></a>
														</font>
													</td>
												</tr>
												<tr>
													<td width="30%" style="border: 1px solid #cccccc; padding-left: 20">
														②[결제수단 선택페이지] 표기방법</td>
													<td width="70%" style="border: 1px solid #cccccc; padding-left: 40">
														<a href="../design/codi.jsp?design_file=order/order.htm" target="_blank">
															<font class="extext"><font class="extext_l">
																[디자인관리 &gt; 기타페이지 디자인 &gt; 주문하기 &gt; order.htm]
															</font></font>
														</a>
														<font class="extext"> 
															을 눌러<br> 치환코드 <font class="ver8" color="000000"><b>{=displayEggBanner(1)}</b></font>	를 삽입하세요. 
															<a href="../design/codi.jsp?design_file=order/order.htm" target="_blank"><font class="extext_l">[바로가기]</font></a>
														</font>
													</td>
												</tr>
											</tbody>
						...
						<table cellpadding="1" cellspacing="0" border="0" class="small_tip">
							<tbody>
								<tr><td><img src="/resources/shop/admin/img/icon_list.gif" align="absmiddle"><font class="extext"><b>구매안전서비스 가입 표기 의무화 안내 (2007년 9월 1일 시행)</b></font></td></tr>
		...
		<div class="title">현금영수증 <!--span>설정된 PG사의 현금영수증을 사용하며, 별도 계약을 해야 함</span--> 
		<!--<a href="javascript:popup('http://guide.godo.co.kr/season2/board/view.php?id=basic&no=6',870,800)"><img src="../img/btn_q.gif" border="0" align="absmiddle"></a>-->
		</div>
			<table border="1" bordercolor="#e1e1e1" style="border-collapse:collapse" width="100%">
				<colgroup>
				...
				<tbody>
					<tr>
						...
						<td class="noline">
							...
							<br><font class="extext" style="padding-left:5px"><a href="http://www.allatpay.com/servlet/AllatBiz/svcinfo/si_receipt_apply.jsp?menu_id=idS16" target="_blank">올앳 현금영수증을 사용하시기 위해서는 현금영수증신청서를 올앳으로 우편발송해 주세요.</a></font>	
							<span style="padding-left:5px"><font class="extext">(설정된 PG사의 현금영수증을 사용하며, 별도 계약을 해야 함)</font></span>	
						</td>
					</tr>
				</tbody>
			</table><p>
			...
			<table cellpadding="1" cellspacing="0" border="0" class="small_ex">
				<tbody>
					...
					<tr>	
						<td><img src="/resources/shop/admin/img/icon_list.gif" align="absmiddle">현금영수증</td>
					</tr>
					<tr>
						<td><img src="/resources/shop/admin/img/icon_list.gif" align="absmiddle">소비자는 2008. 7. 1일부터 현금영수증 발급대상금액이 5천원이상에서 1원이상으로 변경되어
							5천원 미만의 현금거래도 현금영수증을 요청하여 발급 받을 수 있습니다.
						</td>
					</tr>
					<tr>
						<td><img src="/resources/shop/admin/img/icon_list.gif" align="absmiddle">현금영수증 사용 체크시 무통장, 계좌이체, 가상계좌 결제에 대해서 소비자가 신청한 현금영수증이 발급 됩니다</td>
					</tr>
				</tbody>
			</table>
		</div>
