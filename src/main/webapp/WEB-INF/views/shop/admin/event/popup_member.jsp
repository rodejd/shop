...
<jsp:include page="../common/header_popup.jsp" flush="true"/>
<%-- 
...
<c:forEach items="${memberVO.gdMemberList }" var="list" varStatus="vnum">
	...
	<tr height=30 align="center">
		...
		<%-- nickname 삭제
			<br />
			<div style="padding-top:2"><img src="../img/icon_nic.gif" align="absmiddle" /><font class="small1" color="#488d00"><%= rtList.get(i,"nickname") %></font></div>
		 --%>  
		</td>
		<td>
		...
		<%-- CRM 항목 삭제
		<td>
			<a href="javascript:popupLayer('../member/Crm_view.jsp?m_id=${list.mid}',780,600);"><img src="../img/icon_crmlist<%=rtList.get(i, "sex") %>.gif" /></a>
		</td>
		 --%>
		<td>
			<font class="def">
...
<jsp:include page="../common/popup.bottom.jsp" flush="true"/>
<%-- 
