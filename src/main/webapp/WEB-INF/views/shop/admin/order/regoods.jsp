...
<form method="post" action="indb">
	...
	<table width="100%" cellpadding="2" cellspacing="0">
		...
		<tr>
			...
			<td><a href="javascript:popup('../popup.order?ordno=${list.ordno}',800,600)"><font class="ver71" color="0074BA"><b>${list.ordno}</b></font></a></td>
			<td>
		...
		<tr>
			<td colspan="10" style="padding:5px 10px" align="left">
				<table width="100%" border="1" bordercolor="#dedede" style="border-collapse:collapse">
					...
					<c:set value="${list.infoList }" var="infoList"/>
					<tr>
						<td>
							<table>
								<tr>
									...
									<td style="padding-left:3px"><font class="small" color="444444">
										<a href="${ctx}/shop/goods/goods_view?goodsno=${infoList.goodsno}" target="_blank">
										<font color=0074BA><b>${infoList.goodsnm}</b></font></a></font>
