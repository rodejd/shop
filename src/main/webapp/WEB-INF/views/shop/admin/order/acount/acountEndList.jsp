...
<!-- 표 -->
						<table id="goodsList" width="100%" cellpadding="0" cellspacing="0" border="0">
							...
							<tbody>
								...
								<tr height="25">
									<td class="center">정산일자1</td>
									<td class="center">입점업체1</td>
									<td class="center">결제비용1</td>
									<td class="center">수수료1</td>
									<td class="center">배송료1</td>
									<td class="center">적립금1</td>
									<td class="center">쿠폰할인1</td>
									<td class="center">실결제1</td>
									<td class="center">정산금액1</td>
									<td class="center">정산상태1</td>
									<td class="center">최종수정일1</td>
								</tr>
								<tr height="25">
									<td class="center">정산일자2</td>
									<td class="center">입점업체2</td>
									<td class="center">결제비용2</td>
									<td class="center">수수료2</td>
									<td class="center">배송료2</td>
									<td class="center">적립금2</td>
									<td class="center">쿠폰할인2</td>
									<td class="center">실결제2</td>
									<td class="center">정산금액2</td>
									<td class="center">정산상태2</td>
									<td class="center">최종수정일2</td>
								</tr>
