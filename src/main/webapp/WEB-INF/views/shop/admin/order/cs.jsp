			...
			<form class="js_csForm" method="post">
				...
				<table class="tb">
					...
					<tr>
						...
						<td class="noline">
							<table>
								<tr>
								<!-- 배열로 잘 들어가는지 확인 -->
									<td><label><input class="js_type" type="checkbox" name="type" value="40"><font class="small1" color="5C5C5C">취소요청</font></label></td>
									<td><label style="margin: 0 0 0 3px;"><input class="js_type" type="checkbox" name="type" value="56"><font class="small1" color="5C5C5C">취소완료</font></label></td>
									<td><label style="margin: 0 0 0 3px;"><input class="js_type" type="checkbox" name="type" value="58"><font class="small1" color="5C5C5C">취소완료 수집완료</font></label></td>
									<td><label style="margin: 0 0 0 3px;"><input class="js_type" type="checkbox" name="type" value="79"><font class="small1" color="5C5C5C">반품신청</font></label></td>
									<td><label style="margin: 0 0 0 3px;"><input class="js_type" type="checkbox" name="type" value="80"><font class="small1" color="5C5C5C">반품회수중</font></label></td>
									<td><label style="margin: 0 0 0 3px;"><input class="js_type" type="checkbox" name="type" value="81"><font class="small1" color="5C5C5C">반품검수중</font></label></td>
									<td><label style="margin: 0 0 0 3px;"><input class="js_type" type="checkbox" name="type" value="82"><font class="small1" color="5C5C5C">반품(환불)확정</font></label></td>
									<td><label style="margin: 0 0 0 3px;"><input class="js_type" type="checkbox" name="type" value="83"><font class="small1" color="5C5C5C">반품(환불)완료</font></label></td>
								</tr>
							</table>
					...
					<tr>
						<td>판매사명</td>
						<td>
							<input type="text" name="schSellerNm" id="schSellerNm" value="${csVO.schSellerNm}" class="line" style="height:22px" />
							<input type="button" value="판매사 조회" onclick="popupLayer('${ctx}/shop/admin/common/sellerSearchPopup', 600, 500);" />
							<input type="hidden" name="schSellerCd" id="schSellerCd" value="${csVO.schSellerCd}" />
						</td>
					</tr>
					 --%>
					<tr>
		...
		<c:when test="${listSize > 0 }">
			<c:forEach items="${cancelList}" var="cancelData" varStatus="status">
				<tr bgcolor="${cancelData.bgColor}" height="25">
					...
					<!-- 주문번호 -->
					<td align="center">
						<a href="javascript:popup('popup.order?ordno=${cancelData.ordno}',1500,1300,'order')">
					...
					<td align="center">
						<font class="ver71">
							<b>
								${shopLibFunction:getExchange(cancelData.pay, 'kr')}
							</b> 
						</font>
					</td>
