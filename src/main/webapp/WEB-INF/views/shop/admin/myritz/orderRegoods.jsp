...
<form method="post" action="orderIndb">
	...
	<table width="100%" cellpadding="2" cellspacing="0">
		...
		<tr>
			...
			<td><a href="javascript:popup('${ctx}/shop/admin/myritz/myritzPopupOrder?ordno=${list.ordno}',800,600)"><font class="ver71" color="0074BA"><b>${list.ordno}</b></font></a></td>
			<td>
							...
							<table>
								<tr>
									...
									<td style="padding-left:3px"><font class="small" color="444444">
										<a href="${ctx}/shop/goods/goods_view?goodsno=${infoList.goodsno}" target="_blank">
										<font color=0074BA><b>${infoList.goodsnm} [판매사 : ${infoList.myritzNm }]</b></font></a></font>
