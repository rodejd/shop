...
function questsubmit(){
	var schMyritzCd = document.getElementById("schMyritzNm").value;
	if(''==schMyritzCd){
		alert("판매사명을 선택해 주세요");
	}else{
			...
			<table class="tb" border="1" bordercolor="#e6e6e6" cellpadding="5" style="width: 100%; border-collapse: collapse;">
				...
				<tbody>
					<tr>
						<td>판매자</td>
						<td colspan="3">
						<input type=hidden id=schMyritzCd name=questionVO.myritzCd class=lline  readonly="readonly" >
						<input type=text id=schMyritzNm  class=lline  readonly="readonly" >
