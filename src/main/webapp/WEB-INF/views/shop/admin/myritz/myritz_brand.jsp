...
<form name="search" id="myritzSearchForm">
 <div>
 		...
 		<tr>
		 	...
		 	<td width="30%" align="right">
		 		<select name="skey">
					...
					<option value="sMyritzNm"${stringUtil:selected(BrandVO.skey, "sMyritzNm")}>판매자명</option>
...
<form name="frmList" method="post" onsubmit="return chkForm(this)">
	...
	<c:forEach items="${BrandVO.myritzBrandList}" var="list" varStatus="i" >
		<tr height=30 align="center">
			...
			<td>
				<c:choose>
				    <c:when test="${empty list.myritzNm}">
				        	관리자
				    </c:when>
				    <c:otherwise>
				        ${list.myritzNm}
...
<!-- 			수정 삭제 -->
				...
				<a href="${ctx}/shop/admin/myritz/goodsBrand?brandno=${list.sno}&myritzCd=${list.myritzCd}" target="_blank">
				<img src="/resources/shop/admin/img/i_edit.gif" ></a>
				<a href="javascript:popupLayer('${ctx}/shop/admin/myritz/popup.myritzDelBrand?brandno='+${list.sno});">
