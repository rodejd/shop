		...
		<td valign="top" style="padding-left: 12px">
			...
			<table class="tb" border="1" bordercolor="#e6e6e6" cellpadding="5" style="width: 100%; border-collapse: collapse;">
				...
				<tbody>
					<tr>
						<td>제목</td>
						<td colspan="3"> ${adminMyritzQuestAnswerFM.questionVO.title }</td>
					</tr>
					<tr>
					
						<td>등록일</td>
						<td>
							${dateUtil:formatDate(adminMyritzQuestAnswerFM.questionVO.regDt, "yyyy-MM-dd")}
						
						</td>
					</tr>
					<tr>
						<td>내용</td>
						<td colspan="3">${adminMyritzQuestAnswerFM.questionVO.contents}</td>
					</tr>
				</tbody>
			</table><br/><br/><br/>
<!-- 			<form action="answerindb" id="form" name="form" method="post"> -->
<%-- 			<input type="hidden" name="answerVO.qno" value="${adminMyritzQuestAnswerFM.schText}"> --%>
<%-- 			<input type="hidden" name="schText" value="${adminMyritzQuestAnswerFM.schText}"> --%>
...
<!-- 						<tr> -->
<!-- 							<td>판매사</td> -->
<%-- 							<td>${adminMyritzQuestAnswerFM.questionVO.myritzNm}</td> --%>
<!-- 						</tr> -->
<!-- 						<tr> -->
<!-- 							<td>답변 </td> -->
<!-- 							<td colspan="3"> -->
<%-- 								${adminMyritzQuestAnswerFM.questionVO.myritzNm} --%>
<%-- 							<textarea id="body" name="answerVO.answer" style="width:100%;height:350px" type="editor">${adminMyritzQuestAnswerFM.answerVO.answer}</textarea> --%>
	...
	<table width="100%"  class="tb" border="1" bordercolor="#e6e6e6"  cellpadding="0" cellspacing="0" border="1">
		...
		<tr height=30 align="center"> 
			<td><strong>답변달기</strong>
				<input type="hidden" id="qno" name="answerVO.qno" value="${adminMyritzQuestAnswerFM.schText}">
			</td> 
...
<!-- 				<input type="image" id="btn_register"style=" padding: 5px 0px 0px 15px;  border: 0;" src="/resources/shop/admin/img/btn_register.gif">			 -->
	...
	<c:forEach items="${adminMyritzQuestAnswerFM.answerlist}" var="list" varStatus="i" >
		<tr height=30 align="center">
			<td>
				<strong>
					 ${list.regId } 
