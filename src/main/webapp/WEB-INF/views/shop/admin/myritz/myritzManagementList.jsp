...
// 		return;
		...
		$('form[name=frmDnXls]').attr('action', "../myritz/myritzExcelDown");
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr>
			<td width="20%" height=35 style="padding-left:13px">
				<input type="image" class="button_top" src="/resources/shop/admin/img/btn_myritz_add.gif" 	alt="판매사 등록" border="0" align='absmiddle' style="cursor:hand"
