...
{	
	...
	ifrmbrand.location.href = "iframe.myritzBrand?ifrmScroll=1&brandno="+brandno+"&selector=${selector}";
}
...
<input type=hidden name=rtn_query>
			...
			<td valign=top width=100% style="padding-left:10px">
				<iframe id=ifrmbrand name=ifrmbrand src="iframe.myritzBrand?ifrmScroll=1&brandno=${brandVO.brandno}&selector=${selector}" style="width:100%;height:500px" frameborder=0></iframe>
			</td>
		</tr>
		</table>
