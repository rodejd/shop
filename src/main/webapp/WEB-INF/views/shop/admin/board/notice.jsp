...
<div class="title title_top">공지사항<span></span> <!-- <a href="javascript:popup('http://guide.godo.co.kr/season2/board/view.jsp?id=board&no=8',870,800)"><img src="../img/btn_q.gif" border=0 align=absmiddle hspace=2></a> --></div>
<table class=tb>
...
<tr>
	...
	<td>
		<select name="schSkin">
			...
			${webUtil:makeSelectCodeItem((codeUtil:codeitem('skin')), noticeVO.schSkin) }
		</select>
	</td>
</tr>
</table>
