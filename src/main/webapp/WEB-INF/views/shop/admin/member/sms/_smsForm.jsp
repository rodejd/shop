...
<tr>
	...
	<a href="javascript:popupLayer('${ctx}/shop/admin/member/sms/register?mode=register');"><img src="/resources/shop/admin/img/btn_smsadd.gif" align="absmiddle" /></a>

	<div style="height:5;font-size:0"></div>
	
	<a href="${ctx}/shop/admin/member/sms/list?ifrmScroll=1" target="ifrmSms"><font color="262626"><b>전체보기</b></font></a>
	...
	<tr>
		<c:forEach items="${codeUtil:codeitem3()}" var="codeList" varStatus="st">
			<td width="100" height="25">
				<a href="${ctx}/shop/admin/member/sms/list?ifrmScroll=1&category=${codeList.itemnm}" target="ifrmSms"><font class="small" color="161616">${codeList.itemnm}</a> 
	...
	<iframe id="ifrmSms" name="ifrmSms" src="${ctx}/shop/admin/member/sms/list?ifrmScroll=1" style="width:100%;height:100px" frameborder="0" scrolling="no"></iframe>
	</td>
</tr>
</table>
</div>