...
<form name=frmOrder action="/shop/admin/seller/updateOrder" method=post>
...
<!-- 		<iframe id=ifrmCancel name=ifrmCancel style="width:100%;height:0;" frameborder=0></iframe> -->
	...
	<c:choose>
		<c:when test="${ 'view' == param.viewFlg }">
			<a href="/shop/admin/seller/sellerOrderList?mode=group&period=0&first=1"><img src="/resources/shop/admin/img/btn_list.gif"></a>
		</c:when>
		<c:otherwise>
...
<script>
    ...
    adminSellerOrderAddEvent();
    
    function adminSellerOrderAddEvent() {
