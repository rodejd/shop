		...
		<form method="post" action="repay/indb" id="form01" name="form01">
			...
			<table width="100%" cellpadding="2" cellspacing="0">
				...
				<tr>
					...
					<td>
						<a href="javascript:popup('${ctx}/shop/admin/seller/sellerPopupOrder?ordno=${repayList.oCordno}',800,600)"><font class="ver71" color="0074BA"><b>${repayList.oCordno}</b></font></a>
					</td>
					<td>
