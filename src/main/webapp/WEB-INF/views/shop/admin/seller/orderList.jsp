...
<script language="javascript">
	...
	function dnXls(mode){
		...
		$('form[name=frmDnXls]').attr('action', ctx+"/shop/admin/seller/orderExcelDown");
...
<c:forEach items="${orderFM.orderList}" var="list" varStatus="i">
	...
	<!-- 주문흐름보기 끝 -->
		...
		<tr height="25" bgcolor="${bgcolor}" bg="${bgcolor}" align="center">
			...
			<td align="left">
				<a href="${ctx}/shop/admin/seller/sellerPopupOrder?ordno=${list.ordno}&viewFlg=view"><font class="ver81" color="0074BA"><b>${list.ordno}</b></font></a>
				<a href="javascript:popup('${ctx}/shop/admin/seller/sellerPopupOrder?ordno=${list.ordno}',800,600)"><img src="/resources/shop/admin/img/btn_newwindow.gif" border="0" align="absmiddle"></a>
			</td>
			<td align="left">
				<div style="height: 13px; overflow-y: hidden;">
					<c:if test="${ list.oldordno != '' }">
						<a href="javascript:popup('${ctx}/shop/admin/seller/sellerPopupOrder?ordno=${list.ordno}',800,600)"><img src="/resources/shop/admin/img/icon_twice_order.gif"></a>
					</c:if>
					<c:if test="${ list.escrowyn == 'y' }">
						<a href="javascript:popup('${ctx}/shop/admin/seller/sellerPopupOrder?ordno=${list.ordno}',800,600)"><img src="/resources/shop/admin/img/btn_escrow.gif"></a>
					</c:if>
					<c:if test="${ list.eggyn == 'y' }">
						<a href="javascript:popup('${ctx}/shop/admin/seller/sellerPopupOrder?ordno=${list.ordno}',800,600)"><img src="/resources/shop/admin/img/icon_guar_order.gif"></a>
					</c:if>
