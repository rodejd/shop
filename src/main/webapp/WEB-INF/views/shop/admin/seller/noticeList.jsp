...
<form id="form" method="get" action="${ctx}/shop/admin/seller/noticeList">
	...
	<c:when test="${null != noticeFM.noticeList and 0 < noticeFM.noticeList.size()}">
		<c:forEach items="${noticeFM.noticeList}" var="list" varStatus="st">		
			...
			<tr height=25>
				...
				<td class=cell><a href="${ctx}/shop/admin/seller/noticeView?noticeVO.sno=${list.sno}">${list.title}</a></td>
