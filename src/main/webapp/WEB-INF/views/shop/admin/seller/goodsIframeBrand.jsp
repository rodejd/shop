...
<form name=form method=post action="sellerBrand/indb">
	...
	<table class=tb>
		...
		<tr>
			...
			<c:if test="${brandVO.brandno != 0 }">
				<a href="${ctx}/shop/admin/seller/goodsBrand?brandno=${brandVO.brandObj.sno}" target=_blank><img src="/resources/shop/admin/img/i_nowview.gif" border=0 align=absmiddle hspace=10></a>
			</c:if>
			</td>
		</tr>
		<tr>
...
<!-- 						<input type="button" value="판매사 조회" onclick="popupLayer('/shop/admin/common/sellerSearchPopup', 600, 500);" /> -->
				...
				<tr>
					<td>브랜드 삭제 </td>
					<td><a href="javascript:popupLayer('popup.sellerDelBrand?brandno='+${brandVO.brandno});"><img src="/resources/shop/admin/img/i_del.gif" border=0 align=absmiddle></a>
				</tr>
			</table>
