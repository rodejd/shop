...
<!-- 상품 카테고리 선택 -->
	...
	<div class="noline" style="padding-bottom:5px">
		<input type="radio" name="useSeller" value="1" checked > 판매사 등록
	</div>
	
	<table id="tbSeller" class="tb">
		<col class="cellC">
		<col class="cellL">
		<tr>
			<td>판매사</td>
			<td>
				<input type="text" name="schSellerNm" id="schSellerNm" value="${'' ne goodsVO.goodsObj.sellerNm? goodsVO.goodsObj.sellerNm : goodsVO.schSellerNm }" class="line" style="height:22px" disabled="disabled"/>
...
<%-- 									<c:set var='tmpStr1' value='${fn:substring(tmpArray,fn:indexOf(tmpArray,"]")+1,fn:length(tmpArray))}'/> --%>
		...
		<div class="button">
			...
			<c:set var='returnUrl' value='/shop/admin/seller/goodsList'/>
