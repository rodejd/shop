...
<div style="padding-top:40px"></div>
 ...
 <div>
 	<table width="100%" cellpadding="0" cellspacing="0" border="0">
 		<tr>
		 	<td width="70%" align="left">문의 ${adminSellerQuestAnswerFM.rowCount }개 등록되어 있습니다.</td>
		</tr>
	</table>
 </div>
<form name="frmList" method="post" onsubmit="return chkForm(this)">
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<c:choose>
			<c:when test="${null != adminSellerQuestAnswerFM.questionlist and 0 < adminSellerQuestAnswerFM.questionlist.size()}">
				<c:forEach items="${adminSellerQuestAnswerFM.questionlist}" var="list" varStatus="i" >
					
					<tr height=30 align="center">
						<td>
							${(adminSellerQuestAnswerFM.pageNo-1)*10+i.count} 
						</td>
						<td>
							${list.sellerNm }
						</td>
						<td>
							<a href="${ctx}/shop/admin/seller/adminanswer?schType=qno&schText=${list.sno} ">
								<c:choose>
	...
	<!-- 페이징  -->
	<tags:paginator currentPageNo="${adminSellerQuestAnswerFM.pageNo}" rowCount="${adminSellerQuestAnswerFM.rowCount}" pageSize="${adminSellerQuestAnswerFM.pageSize}"  pageGroupSize="${adminSellerQuestAnswerFM.pageGroupSize}" />

		<div style="padding:20px" align="center" class="noline">
			<div class="button">
				<a href="${ctx}/shop/admin/seller/adminQuest">
