...
<table class=tb>
	...
	<c:forEach items="${popupVO.delivery}" var="delivery">
		...
		<tr>
			...
			<td class="cellM">
				<span class="_add-delivery-price2">
					₩<fmt:formatNumber value="${delivery.addDeliveryPrice}" pattern="#,###"/>
				</span>
			</td>			
			<td class="cellM">
